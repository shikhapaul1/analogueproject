...
<body>
  ...
  <div class="card shadow-lg">
    ...
    <div class="card-body">
      <form method="post" action="{{ route('edit.class') }}" enctype="multipart/form-data">
        @csrf
        <div class="mb-3">
          <label for="name" class="form-label">Name</label>
          <input type="text" id="name" class="form-control" value="{{$data->name}}" name="name" placeholder="Enter name">
